  ...
  const handleSubmitContact=(e)=>{
    ...
    if(!userContact.username || !userContact.email || !userContact.message){
      ...
      return toast.error("All fields must be completed")
        ...
        try{ 
            addDoc(collection(db,"contactUser"),{ // contactUser can be anything it is name of collection
            user:userContact.username,email:userContact.email,msg:userContact.message,
         })
         .then(()=> {
              ...
              <div className="bg-white relative   flex flex-wrap py-6 rounded shadow-md">
                ...
                <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                  ...
                  <a className="text-indigo-500 leading-relaxed">
                   Khaijudipesh@gmail.com
                  </a>
                  <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">
                    PHONE
                  </h2>
                  <p className="leading-relaxed">9861488886</p>
                </div>
              </div>
            </div>
